// TransactionsPage: Live Transaction Ingestion, Real-Time Scoring Feed & Multi-Criteria Filter Drawer
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-400">Live Transaction Ingestion, Real-Time Scoring Feed & Multi-Criteria Filter Drawer</p>
        </div>
