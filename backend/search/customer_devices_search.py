"""Full-Text Search Document Builder for CustomerDevice."""

from typing import Dict, Any, List
from backend.core.logging import get_logger

logger = get_logger("customer_devices_search")

class CustomerDeviceSearchIndex:
    INDEX_NAME = "finguard_customer_devices"
