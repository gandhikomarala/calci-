"""SQLAlchemy 2.0 Mapped Entity Model for Investigation (Analyst fraud case management, investigation workflows, and dossiers)."""
...
class Investigation(Base, TimestampMixin, SoftDeleteMixin):
    ...
    __table_args__ = (
        Index("ix_investigations_created_active", "created_at", "is_active"),
    )

    def __repr__(self) -> str:
        return f"<Investigation(id='{self.id}', code='{self.code}', is_active={self.is_active})>"
