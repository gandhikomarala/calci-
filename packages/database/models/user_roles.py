"""SQLAlchemy 2.0 Mapped Entity Model for UserRole (Role binding and tenant permission matrix)."""
...
class UserRole(Base, TimestampMixin, SoftDeleteMixin):
    ...
    __table_args__ = (
        Index("ix_user_roles_created_active", "created_at", "is_active"),
    )

    def __repr__(self) -> str:
        return f"<UserRole(id='{self.id}', code='{self.code}', is_active={self.is_active})>"
