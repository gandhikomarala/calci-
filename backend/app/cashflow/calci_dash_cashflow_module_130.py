"""
Calci Studio — Scientific RPN & Loan Amortization Suite — Discounted Cash Flow (DCF) & IRR Calculator (Unit 130)
...
@dataclass
class CashflowAnalyzerState_130:
    state_id: str
    is_valid: bool
...
class CashflowAnalyzer_130:
    ...
    def __init__(self, node_tag: str = "node_calci_dash_130"):
        ...
        self.active_state_cache: Dict[str, CashflowAnalyzerState_130] = {}

    def execute_processing_cycle(self, input_data: List[float], user_context: str = "production_client") -> CashflowAnalyzerState_130:
        self.invocations += 1
        ...
        state = CashflowAnalyzerState_130(
