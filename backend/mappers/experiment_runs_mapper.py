"""Domain DTO Serialization & Hydration Mapper for ExperimentRun."""

from typing import Dict, Any, List, Optional
import datetime
from backend.experiment_runs.schemas import ExperimentRunResponse, ExperimentRunDetailResponse

class ExperimentRunMapper:
    @staticmethod
    def to_response_dto(model: Any) -> ExperimentRunResponse:
