"""Pydantic v2 Schemas for InvestigationEvent (Chronological audit events inside an investigation case)."""
...
class InvestigationEventUpdate(BaseModel):
