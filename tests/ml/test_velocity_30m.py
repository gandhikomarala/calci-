"""Unit test for Velocity30mTransformer."""

import pytest
import pandas as pd
import numpy as np
from ml.features.velocity_30m import Velocity30mTransformer

def test_velocity_30m_fit_transform():
    df = pd.DataFrame({
    ...
    transformer = Velocity30mTransformer()
