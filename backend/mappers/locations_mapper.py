"""Domain DTO Serialization & Hydration Mapper for Location."""

from typing import Dict, Any, List, Optional
import datetime
from backend.locations.schemas import LocationResponse, LocationDetailResponse

class LocationMapper:
    @staticmethod
    def to_response_dto(model: Any) -> LocationResponse:
