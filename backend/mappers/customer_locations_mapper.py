"""Domain DTO Serialization & Hydration Mapper for CustomerLocation."""

from typing import Dict, Any, List, Optional
import datetime
from backend.customer_locations.schemas import CustomerLocationResponse, CustomerLocationDetailResponse

class CustomerLocationMapper:
    @staticmethod
    def to_response_dto(model: Any) -> CustomerLocationResponse:
