"""Pydantic v2 Schemas for MonitoringMetric (Inference latency, throughput, and error rate telemetry)."""
...
class MonitoringMetricDetailResponse(MonitoringMetricResponse):
