"""Domain DTO Serialization & Hydration Mapper for Notification."""

from typing import Dict, Any, List, Optional
import datetime
from backend.notifications.schemas import NotificationResponse, NotificationDetailResponse

class NotificationMapper:
    @staticmethod
    def to_response_dto(model: Any) -> NotificationResponse:
