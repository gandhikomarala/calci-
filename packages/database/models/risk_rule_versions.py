"""SQLAlchemy 2.0 Mapped Entity Model for RiskRuleVersion (Immutable version history of risk detection rules)."""
...
class RiskRuleVersion(Base, TimestampMixin, SoftDeleteMixin):
    ...
    __table_args__ = (
        Index("ix_risk_rule_versions_created_active", "created_at", "is_active"),
    )

    def __repr__(self) -> str:
        return f"<RiskRuleVersion(id='{self.id}', code='{self.code}', is_active={self.is_active})>"
