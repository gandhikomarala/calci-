"""SQLAlchemy 2.0 Mapped Entity Model for InvestigationAssignment (Analyst case assignments and workload balancing)."""
...
class InvestigationAssignment(Base, TimestampMixin, SoftDeleteMixin):
    ...
    __table_args__ = (
        Index("ix_investigation_assignments_created_active", "created_at", "is_active"),
    )

    def __repr__(self) -> str:
        return f"<InvestigationAssignment(id='{self.id}', code='{self.code}', is_active={self.is_active})>"
