"""Domain DTO Serialization & Hydration Mapper for RiskRule."""

from typing import Dict, Any, List, Optional
import datetime
from backend.risk_rules.schemas import RiskRuleResponse, RiskRuleDetailResponse

class RiskRuleMapper:
    @staticmethod
    def to_response_dto(model: Any) -> RiskRuleResponse:
