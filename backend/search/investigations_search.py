"""Full-Text Search Document Builder for Investigation."""

from typing import Dict, Any, List
from backend.core.logging import get_logger

logger = get_logger("investigations_search")

class InvestigationSearchIndex:
    INDEX_NAME = "finguard_investigations"
