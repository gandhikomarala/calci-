"""Unit test for SharedDeviceRiskTransformer."""

import pytest
import pandas as pd
import numpy as np
from ml.features.shared_device_risk import SharedDeviceRiskTransformer

def test_shared_device_risk_fit_transform():
    df = pd.DataFrame({
    ...
    transformer = SharedDeviceRiskTransformer()
