"""SQLAlchemy 2.0 Mapped Entity Model for ModelMetric (Validated test set performance metrics for model versions)."""
...
class ModelMetric(Base, TimestampMixin, SoftDeleteMixin):
    ...
    __table_args__ = (
        Index("ix_model_metrics_created_active", "created_at", "is_active"),
    )

    def __repr__(self) -> str:
        return f"<ModelMetric(id='{self.id}', code='{self.code}', is_active={self.is_active})>"
