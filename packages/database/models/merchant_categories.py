"""SQLAlchemy 2.0 Mapped Entity Model for MerchantCategory (Merchant MCC taxonomy and high-risk category definitions)."""
...
class MerchantCategory(Base, TimestampMixin, SoftDeleteMixin):
    ...
    __table_args__ = (
        Index("ix_merchant_categories_created_active", "created_at", "is_active"),
    )

    def __repr__(self) -> str:
        return f"<MerchantCategory(id='{self.id}', code='{self.code}', is_active={self.is_active})>"
