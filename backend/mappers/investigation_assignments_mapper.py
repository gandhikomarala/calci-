"""Domain DTO Serialization & Hydration Mapper for InvestigationAssignment."""

from typing import Dict, Any, List, Optional
import datetime
from backend.investigation_assignments.schemas import InvestigationAssignmentResponse, InvestigationAssignmentDetailResponse

class InvestigationAssignmentMapper:
    @staticmethod
    def to_response_dto(model: Any) -> InvestigationAssignmentResponse:
        return InvestigationAssignmentResponse(
