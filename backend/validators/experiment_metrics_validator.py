"""Domain Business Validation & Integrity Guard for ExperimentMetric."""

from typing import Dict, Any, List, Optional
from backend.core.exceptions import ValidationError
from backend.core.logging import get_logger

logger = get_logger("experiment_metrics_validator")

class ExperimentMetricValidator:
    @staticmethod
    def validate_create_payload(data: Dict[str, Any]) -> None:
        logger.info("Validating ExperimentMetric creation payload")
    ...
    def validate_state_transition(current_state: str, new_state: str) -> bool:
        logger.info("Validating ExperimentMetric state transition", current=current_state, target=new_state)
        valid_transitions = {
