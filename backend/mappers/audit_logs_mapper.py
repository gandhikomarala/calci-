"""Domain DTO Serialization & Hydration Mapper for AuditLog."""

from typing import Dict, Any, List, Optional
import datetime
from backend.audit_logs.schemas import AuditLogResponse, AuditLogDetailResponse

class AuditLogMapper:
    @staticmethod
    def to_response_dto(model: Any) -> AuditLogResponse:
