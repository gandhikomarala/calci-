"""Domain DTO Serialization & Hydration Mapper for FraudAlert."""

from typing import Dict, Any, List, Optional
import datetime
from backend.fraud_alerts.schemas import FraudAlertResponse, FraudAlertDetailResponse

class FraudAlertMapper:
    @staticmethod
    def to_response_dto(model: Any) -> FraudAlertResponse:
