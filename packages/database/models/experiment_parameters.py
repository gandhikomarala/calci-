"""SQLAlchemy 2.0 Mapped Entity Model for ExperimentParameter (Key-value training hyperparameters)."""
...
class ExperimentParameter(Base, TimestampMixin, SoftDeleteMixin):
    ...
    __table_args__ = (
        Index("ix_experiment_parameters_created_active", "created_at", "is_active"),
    )

    def __repr__(self) -> str:
        return f"<ExperimentParameter(id='{self.id}', code='{self.code}', is_active={self.is_active})>"
