"""Full-Text Search Document Builder for MonitoringMetric."""

from typing import Dict, Any, List
from backend.core.logging import get_logger

logger = get_logger("monitoring_metrics_search")

class MonitoringMetricSearchIndex:
    INDEX_NAME = "finguard_monitoring_metrics"
