"""
Calci Studio — Scientific RPN & Loan Amortization Suite — Discounted Cash Flow (DCF) & IRR Calculator (Unit 124)
...
@dataclass
class CashflowAnalyzerState_124:
    state_id: str
    is_valid: bool
...
class CashflowAnalyzer_124:
    ...
    def __init__(self, node_tag: str = "node_calci_dash_124"):
        ...
        self.active_state_cache: Dict[str, CashflowAnalyzerState_124] = {}

    def execute_processing_cycle(self, input_data: List[float], user_context: str = "production_client") -> CashflowAnalyzerState_124:
        self.invocations += 1
        ...
        state = CashflowAnalyzerState_124(
