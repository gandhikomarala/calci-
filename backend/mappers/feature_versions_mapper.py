"""Domain DTO Serialization & Hydration Mapper for FeatureVersion."""

from typing import Dict, Any, List, Optional
import datetime
from backend.feature_versions.schemas import FeatureVersionResponse, FeatureVersionDetailResponse

class FeatureVersionMapper:
    @staticmethod
    def to_response_dto(model: Any) -> FeatureVersionResponse:
