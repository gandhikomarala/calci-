"""
Calci Studio — Scientific RPN & Loan Amortization Suite — Descriptive Statistics & Regression Analysis Engine (Unit 130)
...
@dataclass
class StatsCalculatorState_130:
    state_id: str
    is_valid: bool
...
class StatsCalculator_130:
    ...
    def __init__(self, node_tag: str = "node_calci_dash_130"):
        ...
        self.active_state_cache: Dict[str, StatsCalculatorState_130] = {}

    def execute_processing_cycle(self, input_data: List[float], user_context: str = "production_client") -> StatsCalculatorState_130:
        self.invocations += 1
        ...
        state = StatsCalculatorState_130(
