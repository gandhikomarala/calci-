"""SQLAlchemy 2.0 Mapped Entity Model for InvestigationComment (Analyst internal collaboration notes and findings)."""
...
class InvestigationComment(Base, TimestampMixin, SoftDeleteMixin):
    ...
    __table_args__ = (
        Index("ix_investigation_comments_created_active", "created_at", "is_active"),
    )

    def __repr__(self) -> str:
        return f"<InvestigationComment(id='{self.id}', code='{self.code}', is_active={self.is_active})>"
