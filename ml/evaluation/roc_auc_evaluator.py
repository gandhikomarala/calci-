"""Receiver Operating Characteristic Curve and Optimal Youden J-Statistic Finder."""
...
logger = get_logger("roc_auc_evaluator")

class RocAucEvaluator:
    @staticmethod
    def evaluate(y_true: np.ndarray, y_proba: np.ndarray) -> Dict[str, Any]:
        logger.info("Computing roc_auc_evaluator metrics", samples=len(y_true))
