"""SQLAlchemy 2.0 Mapped Entity Model for Account (Bank accounts, currency balances, and limits)."""
...
class Account(Base, TimestampMixin, SoftDeleteMixin):
    ...
    __table_args__ = (
        Index("ix_accounts_created_active", "created_at", "is_active"),
    )

    def __repr__(self) -> str:
        return f"<Account(id='{self.id}', code='{self.code}', is_active={self.is_active})>"
