"""Full-Text Search Document Builder for ModelVersion."""

from typing import Dict, Any, List
from backend.core.logging import get_logger

logger = get_logger("model_versions_search")

class ModelVersionSearchIndex:
    INDEX_NAME = "finguard_model_versions"
