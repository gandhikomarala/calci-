"""Domain DTO Serialization & Hydration Mapper for CustomerDevice."""

from typing import Dict, Any, List, Optional
import datetime
from backend.customer_devices.schemas import CustomerDeviceResponse, CustomerDeviceDetailResponse

class CustomerDeviceMapper:
    @staticmethod
    def to_response_dto(model: Any) -> CustomerDeviceResponse:
