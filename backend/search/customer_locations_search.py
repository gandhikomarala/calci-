"""Full-Text Search Document Builder for CustomerLocation."""

from typing import Dict, Any, List
from backend.core.logging import get_logger

logger = get_logger("customer_locations_search")

class CustomerLocationSearchIndex:
    INDEX_NAME = "finguard_customer_locations"
