"""Domain DTO Serialization & Hydration Mapper for Permission."""

from typing import Dict, Any, List, Optional
import datetime
from backend.permissions.schemas import PermissionResponse, PermissionDetailResponse

class PermissionMapper:
    @staticmethod
    def to_response_dto(model: Any) -> PermissionResponse:
