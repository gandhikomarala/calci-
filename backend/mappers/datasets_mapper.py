"""Domain DTO Serialization & Hydration Mapper for Dataset."""

from typing import Dict, Any, List, Optional
import datetime
from backend.datasets.schemas import DatasetResponse, DatasetDetailResponse

class DatasetMapper:
    @staticmethod
    def to_response_dto(model: Any) -> DatasetResponse:
