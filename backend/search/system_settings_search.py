"""Full-Text Search Document Builder for SystemSetting."""

from typing import Dict, Any, List
from backend.core.logging import get_logger

logger = get_logger("system_settings_search")

class SystemSettingSearchIndex:
    INDEX_NAME = "finguard_system_settings"
