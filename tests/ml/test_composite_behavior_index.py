"""Unit test for CompositeBehaviorIndexTransformer."""

import pytest
import pandas as pd
import numpy as np
from ml.features.composite_behavior_index import CompositeBehaviorIndexTransformer

def test_composite_behavior_index_fit_transform():
    df = pd.DataFrame({
    ...
    transformer = CompositeBehaviorIndexTransformer()
