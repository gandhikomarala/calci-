"""Full-Text Search Document Builder for InvestigationComment."""

from typing import Dict, Any, List
from backend.core.logging import get_logger

logger = get_logger("investigation_comments_search")

class InvestigationCommentSearchIndex:
    INDEX_NAME = "finguard_investigation_comments"
