"""SQLAlchemy 2.0 Mapped Entity Model for MLModel (Registered machine learning model families)."""
...
class MLModel(Base, TimestampMixin, SoftDeleteMixin):
    ...
    __table_args__ = (
        Index("ix_models_created_active", "created_at", "is_active"),
    )

    def __repr__(self) -> str:
        return f"<MLModel(id='{self.id}', code='{self.code}', is_active={self.is_active})>"
