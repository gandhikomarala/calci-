"""Domain DTO Serialization & Hydration Mapper for AlertEvent."""

from typing import Dict, Any, List, Optional
import datetime
from backend.alert_events.schemas import AlertEventResponse, AlertEventDetailResponse

class AlertEventMapper:
    @staticmethod
    def to_response_dto(model: Any) -> AlertEventResponse:
