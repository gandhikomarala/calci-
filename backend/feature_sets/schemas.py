"""Pydantic v2 Schemas for FeatureSet (Feature store groupings and entity catalog definitions)."""
...
class FeatureSetResponse(FeatureSetBase):
...
class FeatureSetFilterParams(BaseModel):
