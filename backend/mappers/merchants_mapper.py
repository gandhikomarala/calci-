"""Domain DTO Serialization & Hydration Mapper for Merchant."""

from typing import Dict, Any, List, Optional
import datetime
from backend.merchants.schemas import MerchantResponse, MerchantDetailResponse

class MerchantMapper:
    @staticmethod
    def to_response_dto(model: Any) -> MerchantResponse:
