"""Domain DTO Serialization & Hydration Mapper for ModelVersion."""

from typing import Dict, Any, List, Optional
import datetime
from backend.model_versions.schemas import ModelVersionResponse, ModelVersionDetailResponse

class ModelVersionMapper:
    @staticmethod
    def to_response_dto(model: Any) -> ModelVersionResponse:
