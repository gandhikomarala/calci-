"""SQLAlchemy 2.0 Mapped Entity Model for SystemSetting (Global runtime configuration, risk thresholds, and rate limits)."""
...
class SystemSetting(Base, TimestampMixin, SoftDeleteMixin):
    ...
    __table_args__ = (
        Index("ix_system_settings_created_active", "created_at", "is_active"),
    )

    def __repr__(self) -> str:
        return f"<SystemSetting(id='{self.id}', code='{self.code}', is_active={self.is_active})>"
