"""Domain DTO Serialization & Hydration Mapper for ApiKey."""

from typing import Dict, Any, List, Optional
import datetime
from backend.api_keys.schemas import ApiKeyResponse, ApiKeyDetailResponse

class ApiKeyMapper:
    @staticmethod
    def to_response_dto(model: Any) -> ApiKeyResponse:
