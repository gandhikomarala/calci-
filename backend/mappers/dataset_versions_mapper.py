"""Domain DTO Serialization & Hydration Mapper for DatasetVersion."""

from typing import Dict, Any, List, Optional
import datetime
from backend.dataset_versions.schemas import DatasetVersionResponse, DatasetVersionDetailResponse

class DatasetVersionMapper:
    @staticmethod
    def to_response_dto(model: Any) -> DatasetVersionResponse:
