"""SQLAlchemy 2.0 Mapped Entity Model for ExperimentRun (Individual model training runs, hyperparameters, and durations)."""
...
class ExperimentRun(Base, TimestampMixin, SoftDeleteMixin):
    ...
    __table_args__ = (
        Index("ix_experiment_runs_created_active", "created_at", "is_active"),
    )

    def __repr__(self) -> str:
        return f"<ExperimentRun(id='{self.id}', code='{self.code}', is_active={self.is_active})>"
