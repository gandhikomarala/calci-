// CustomersPage: Customer Directory, Risk Rating Segments & Historical Chargeback Flags
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-400">Customer Directory, Risk Rating Segments & Historical Chargeback Flags</p>
        </div>
