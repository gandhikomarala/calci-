"""SQLAlchemy 2.0 Mapped Entity Model for AlertEvent (Audit timeline of alert triage, statuses, and assignments)."""
...
class AlertEvent(Base, TimestampMixin, SoftDeleteMixin):
    ...
    __table_args__ = (
        Index("ix_alert_events_created_active", "created_at", "is_active"),
    )

    def __repr__(self) -> str:
        return f"<AlertEvent(id='{self.id}', code='{self.code}', is_active={self.is_active})>"
