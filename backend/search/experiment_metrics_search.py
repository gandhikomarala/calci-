"""Full-Text Search Document Builder for ExperimentMetric."""

from typing import Dict, Any, List
from backend.core.logging import get_logger

logger = get_logger("experiment_metrics_search")

class ExperimentMetricSearchIndex:
    INDEX_NAME = "finguard_experiment_metrics"
