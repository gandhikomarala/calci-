// DatasetsPage: Financial Dataset Catalog, Drag-and-Drop Uploader & Schema Validator
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-400">Financial Dataset Catalog, Drag-and-Drop Uploader & Schema Validator</p>
        </div>
