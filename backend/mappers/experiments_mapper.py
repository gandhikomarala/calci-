"""Domain DTO Serialization & Hydration Mapper for Experiment."""

from typing import Dict, Any, List, Optional
import datetime
from backend.experiments.schemas import ExperimentResponse, ExperimentDetailResponse

class ExperimentMapper:
    @staticmethod
    def to_response_dto(model: Any) -> ExperimentResponse:
