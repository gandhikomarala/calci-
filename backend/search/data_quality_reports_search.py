"""Full-Text Search Document Builder for DataQualityReport."""

from typing import Dict, Any, List
from backend.core.logging import get_logger

logger = get_logger("data_quality_reports_search")

class DataQualityReportSearchIndex:
    INDEX_NAME = "finguard_data_quality_reports"
