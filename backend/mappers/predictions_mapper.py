"""Domain DTO Serialization & Hydration Mapper for Prediction."""

from typing import Dict, Any, List, Optional
import datetime
from backend.predictions.schemas import PredictionResponse, PredictionDetailResponse

class PredictionMapper:
    @staticmethod
    def to_response_dto(model: Any) -> PredictionResponse:
