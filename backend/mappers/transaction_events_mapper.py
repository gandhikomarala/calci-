"""Domain DTO Serialization & Hydration Mapper for TransactionEvent."""

from typing import Dict, Any, List, Optional
import datetime
from backend.transaction_events.schemas import TransactionEventResponse, TransactionEventDetailResponse

class TransactionEventMapper:
    @staticmethod
    def to_response_dto(model: Any) -> TransactionEventResponse:
