"""
Calci Studio — Scientific RPN & Loan Amortization Suite — Discounted Cash Flow (DCF) & IRR Calculator (Unit 121)
...
@dataclass
class CashflowAnalyzerState_121:
    state_id: str
    is_valid: bool
...
class CashflowAnalyzer_121:
    ...
    def __init__(self, node_tag: str = "node_calci_dash_121"):
        ...
        self.active_state_cache: Dict[str, CashflowAnalyzerState_121] = {}

    def execute_processing_cycle(self, input_data: List[float], user_context: str = "production_client") -> CashflowAnalyzerState_121:
        self.invocations += 1
        ...
        state = CashflowAnalyzerState_121(
