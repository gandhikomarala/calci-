"""Unit test for HighRiskCountryTransformer."""

import pytest
import pandas as pd
import numpy as np
from ml.features.high_risk_country import HighRiskCountryTransformer

def test_high_risk_country_fit_transform():
    df = pd.DataFrame({
    ...
    transformer = HighRiskCountryTransformer()
