"""Pydantic v2 Schemas for ExperimentMetric (Step-wise and final evaluation metrics (PR-AUC, ROC-AUC, F1))."""
...
class ExperimentMetricUpdate(BaseModel):
