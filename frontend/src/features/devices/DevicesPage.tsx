// DevicesPage: Device Intelligence Center, Emulator Detection & Multi-Account Clustering
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-400">Device Intelligence Center, Emulator Detection & Multi-Account Clustering</p>
        </div>
