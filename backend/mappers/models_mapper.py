"""Domain DTO Serialization & Hydration Mapper for MLModel."""

from typing import Dict, Any, List, Optional
import datetime
from backend.models.schemas import MLModelResponse, MLModelDetailResponse

class MLModelMapper:
    @staticmethod
    def to_response_dto(model: Any) -> MLModelResponse:
