"""Domain DTO Serialization & Hydration Mapper for RiskScore."""

from typing import Dict, Any, List, Optional
import datetime
from backend.risk_scores.schemas import RiskScoreResponse, RiskScoreDetailResponse

class RiskScoreMapper:
    @staticmethod
    def to_response_dto(model: Any) -> RiskScoreResponse:
