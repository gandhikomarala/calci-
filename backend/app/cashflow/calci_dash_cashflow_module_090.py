"""
Calci Studio — Scientific RPN & Loan Amortization Suite — Discounted Cash Flow (DCF) & IRR Calculator (Unit 090)
...
@dataclass
class CashflowAnalyzerState_090:
    state_id: str
    is_valid: bool
...
class CashflowAnalyzer_090:
    ...
    def __init__(self, node_tag: str = "node_calci_dash_090"):
        ...
        self.active_state_cache: Dict[str, CashflowAnalyzerState_090] = {}

    def execute_processing_cycle(self, input_data: List[float], user_context: str = "production_client") -> CashflowAnalyzerState_090:
        self.invocations += 1
        ...
        state = CashflowAnalyzerState_090(
