"""Domain DTO Serialization & Hydration Mapper for Account."""

from typing import Dict, Any, List, Optional
import datetime
from backend.accounts.schemas import AccountResponse, AccountDetailResponse

class AccountMapper:
    @staticmethod
    def to_response_dto(model: Any) -> AccountResponse:
