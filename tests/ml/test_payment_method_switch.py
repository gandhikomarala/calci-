"""Unit test for PaymentMethodSwitchTransformer."""

import pytest
import pandas as pd
import numpy as np
from ml.features.payment_method_switch import PaymentMethodSwitchTransformer

def test_payment_method_switch_fit_transform():
    df = pd.DataFrame({
    ...
    transformer = PaymentMethodSwitchTransformer()
