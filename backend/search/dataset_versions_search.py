"""Full-Text Search Document Builder for DatasetVersion."""

from typing import Dict, Any, List
from backend.core.logging import get_logger

logger = get_logger("dataset_versions_search")

class DatasetVersionSearchIndex:
    INDEX_NAME = "finguard_dataset_versions"
