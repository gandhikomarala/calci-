"""Domain DTO Serialization & Hydration Mapper for CustomerProfile."""

from typing import Dict, Any, List, Optional
import datetime
from backend.customer_profiles.schemas import CustomerProfileResponse, CustomerProfileDetailResponse

class CustomerProfileMapper:
    @staticmethod
    def to_response_dto(model: Any) -> CustomerProfileResponse:
