"""Unit test for TimeAnomalyTransformer."""

import pytest
import pandas as pd
import numpy as np
from ml.features.time_anomaly import TimeAnomalyTransformer

def test_time_anomaly_fit_transform():
    df = pd.DataFrame({
    ...
    transformer = TimeAnomalyTransformer()
