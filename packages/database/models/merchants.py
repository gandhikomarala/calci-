"""SQLAlchemy 2.0 Mapped Entity Model for Merchant (Merchant entities, category codes, and risk ratings)."""
...
class Merchant(Base, TimestampMixin, SoftDeleteMixin):
    ...
    __table_args__ = (
        Index("ix_merchants_created_active", "created_at", "is_active"),
    )

    def __repr__(self) -> str:
        return f"<Merchant(id='{self.id}', code='{self.code}', is_active={self.is_active})>"
