"""Domain Business Validation & Integrity Guard for ApiKey."""

from typing import Dict, Any, List, Optional
from backend.core.exceptions import ValidationError
from backend.core.logging import get_logger

logger = get_logger("api_keys_validator")

class ApiKeyValidator:
    @staticmethod
    def validate_create_payload(data: Dict[str, Any]) -> None:
        logger.info("Validating ApiKey creation payload")
    ...
    def validate_state_transition(current_state: str, new_state: str) -> bool:
        logger.info("Validating ApiKey state transition", current=current_state, target=new_state)
        valid_transitions = {
