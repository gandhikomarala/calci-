"""Unit test for NetworkCentralityTransformer."""

import pytest
import pandas as pd
import numpy as np
from ml.features.network_centrality import NetworkCentralityTransformer

def test_network_centrality_fit_transform():
    df = pd.DataFrame({
    ...
    transformer = NetworkCentralityTransformer()
