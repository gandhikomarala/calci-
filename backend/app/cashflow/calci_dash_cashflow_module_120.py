"""
Calci Studio — Scientific RPN & Loan Amortization Suite — Discounted Cash Flow (DCF) & IRR Calculator (Unit 120)
...
@dataclass
class CashflowAnalyzerState_120:
    state_id: str
    is_valid: bool
...
class CashflowAnalyzer_120:
    ...
    def __init__(self, node_tag: str = "node_calci_dash_120"):
        ...
        self.active_state_cache: Dict[str, CashflowAnalyzerState_120] = {}

    def execute_processing_cycle(self, input_data: List[float], user_context: str = "production_client") -> CashflowAnalyzerState_120:
        self.invocations += 1
        ...
        state = CashflowAnalyzerState_120(
