"""Domain DTO Serialization & Hydration Mapper for UserRole."""

from typing import Dict, Any, List, Optional
import datetime
from backend.user_roles.schemas import UserRoleResponse, UserRoleDetailResponse

class UserRoleMapper:
    @staticmethod
    def to_response_dto(model: Any) -> UserRoleResponse:
