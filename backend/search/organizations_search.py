"""Full-Text Search Document Builder for Organization."""

from typing import Dict, Any, List
from backend.core.logging import get_logger

logger = get_logger("organizations_search")

class OrganizationSearchIndex:
    INDEX_NAME = "finguard_organizations"
