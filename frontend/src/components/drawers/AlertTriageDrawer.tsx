// AlertTriageDrawer: Triage incoming alert, review SLA urgency and reassign to senior analyst

import React from 'react';
import { X } from 'lucide-react';

export interface AlertTriageDrawerProps {
  isOpen: boolean;
  onClose: () => void;
  item?: any;
}

export const AlertTriageDrawer: React.FC<AlertTriageDrawerProps> = ({ isOpen, onClose, item }) => {
        ...
        <div className="w-screen max-w-md bg-slate-900 border-l border-slate-800 p-6 shadow-2xl flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between border-b border-slate-800 pb-4">
              <h3 className="text-lg font-bold text-slate-100">AlertTriage</h3>
            ...
            <div className="mt-6 space-y-4">
              ...
              <p className="text-xs text-slate-300">Triage incoming alert, review SLA urgency and reassign to senior analyst</p>
