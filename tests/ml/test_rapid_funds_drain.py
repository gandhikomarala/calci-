"""Unit test for RapidFundsDrainTransformer."""

import pytest
import pandas as pd
import numpy as np
from ml.features.rapid_funds_drain import RapidFundsDrainTransformer

def test_rapid_funds_drain_fit_transform():
    df = pd.DataFrame({
    ...
    transformer = RapidFundsDrainTransformer()
