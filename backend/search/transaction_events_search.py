"""Full-Text Search Document Builder for TransactionEvent."""

from typing import Dict, Any, List
from backend.core.logging import get_logger

logger = get_logger("transaction_events_search")

class TransactionEventSearchIndex:
    INDEX_NAME = "finguard_transaction_events"
