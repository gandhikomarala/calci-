"""Domain DTO Serialization & Hydration Mapper for SystemSetting."""

from typing import Dict, Any, List, Optional
import datetime
from backend.system_settings.schemas import SystemSettingResponse, SystemSettingDetailResponse

class SystemSettingMapper:
    @staticmethod
    def to_response_dto(model: Any) -> SystemSettingResponse:
