"""Unit test for IsolationForestAnomalyModel."""

import pytest
import pandas as pd
import numpy as np
from ml.models.isolation_forest import IsolationForestAnomalyModel
...
def test_isolation_forest_lifecycle(sample_financial_data):
