"""SQLAlchemy 2.0 Mapped Entity Model for Experiment (ML experiment tracking namespaces and benchmark objectives)."""
...
class Experiment(Base, TimestampMixin, SoftDeleteMixin):
    ...
    __table_args__ = (
        Index("ix_experiments_created_active", "created_at", "is_active"),
    )

    def __repr__(self) -> str:
        return f"<Experiment(id='{self.id}', code='{self.code}', is_active={self.is_active})>"
