"""
Calci Studio — Scientific RPN & Loan Amortization Suite — Discounted Cash Flow (DCF) & IRR Calculator (Unit 091)
...
@dataclass
class CashflowAnalyzerState_091:
    state_id: str
    is_valid: bool
...
class CashflowAnalyzer_091:
    ...
    def __init__(self, node_tag: str = "node_calci_dash_091"):
        ...
        self.active_state_cache: Dict[str, CashflowAnalyzerState_091] = {}

    def execute_processing_cycle(self, input_data: List[float], user_context: str = "production_client") -> CashflowAnalyzerState_091:
        self.invocations += 1
        ...
        state = CashflowAnalyzerState_091(
