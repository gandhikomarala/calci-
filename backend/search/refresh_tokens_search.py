"""Full-Text Search Document Builder for RefreshToken."""

from typing import Dict, Any, List
from backend.core.logging import get_logger

logger = get_logger("refresh_tokens_search")

class RefreshTokenSearchIndex:
    INDEX_NAME = "finguard_refresh_tokens"
