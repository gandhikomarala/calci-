"""Full-Text Search Document Builder for PredictionBatch."""

from typing import Dict, Any, List
from backend.core.logging import get_logger

logger = get_logger("prediction_batches_search")

class PredictionBatchSearchIndex:
    INDEX_NAME = "finguard_prediction_batches"
