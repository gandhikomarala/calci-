"""Unit test for CurrencyRiskTransformer."""

import pytest
import pandas as pd
import numpy as np
from ml.features.currency_risk_scorer import CurrencyRiskTransformer

def test_currency_risk_scorer_fit_transform():
    df = pd.DataFrame({
    ...
    transformer = CurrencyRiskTransformer()
