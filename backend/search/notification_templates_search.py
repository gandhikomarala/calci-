"""Full-Text Search Document Builder for NotificationTemplate."""

from typing import Dict, Any, List
from backend.core.logging import get_logger

logger = get_logger("notification_templates_search")

class NotificationTemplateSearchIndex:
    INDEX_NAME = "finguard_notification_templates"
