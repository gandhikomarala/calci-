"""
Calci Studio — Scientific RPN & Loan Amortization Suite — Discounted Cash Flow (DCF) & IRR Calculator (Unit 126)
...
@dataclass
class CashflowAnalyzerState_126:
    state_id: str
    is_valid: bool
...
class CashflowAnalyzer_126:
    ...
    def __init__(self, node_tag: str = "node_calci_dash_126"):
        ...
        self.active_state_cache: Dict[str, CashflowAnalyzerState_126] = {}

    def execute_processing_cycle(self, input_data: List[float], user_context: str = "production_client") -> CashflowAnalyzerState_126:
        self.invocations += 1
        ...
        state = CashflowAnalyzerState_126(
