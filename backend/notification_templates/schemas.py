"""Pydantic v2 Schemas for NotificationTemplate (Configurable alert notification message templates)."""
...
class NotificationTemplateDetailResponse(NotificationTemplateResponse):
    extra_attributes: Optional[Dict[str, Any]] = Field(default=None)
    audit_history: Optional[List[Dict[str, Any]]] = Field(default=None)

class NotificationTemplateFilterParams(BaseModel):
