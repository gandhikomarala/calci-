"""Full-Text Search Document Builder for ModelArtifact."""

from typing import Dict, Any, List
from backend.core.logging import get_logger

logger = get_logger("model_artifacts_search")

class ModelArtifactSearchIndex:
    INDEX_NAME = "finguard_model_artifacts"
