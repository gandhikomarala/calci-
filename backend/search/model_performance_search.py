"""Full-Text Search Document Builder for ModelPerformance."""

from typing import Dict, Any, List
from backend.core.logging import get_logger

logger = get_logger("model_performance_search")

class ModelPerformanceSearchIndex:
    INDEX_NAME = "finguard_model_performance"
