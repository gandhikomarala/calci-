"""Domain DTO Serialization & Hydration Mapper for Investigation."""

from typing import Dict, Any, List, Optional
import datetime
from backend.investigations.schemas import InvestigationResponse, InvestigationDetailResponse

class InvestigationMapper:
    @staticmethod
    def to_response_dto(model: Any) -> InvestigationResponse:
