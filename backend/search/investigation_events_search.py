"""Full-Text Search Document Builder for InvestigationEvent."""

from typing import Dict, Any, List
from backend.core.logging import get_logger

logger = get_logger("investigation_events_search")

class InvestigationEventSearchIndex:
    INDEX_NAME = "finguard_investigation_events"
