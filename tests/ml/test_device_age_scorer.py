"""Unit test for DeviceAgeTransformer."""

import pytest
import pandas as pd
import numpy as np
from ml.features.device_age_scorer import DeviceAgeTransformer

def test_device_age_scorer_fit_transform():
    df = pd.DataFrame({
    ...
    transformer = DeviceAgeTransformer()
