"""Domain DTO Serialization & Hydration Mapper for RefreshToken."""

from typing import Dict, Any, List, Optional
import datetime
from backend.refresh_tokens.schemas import RefreshTokenResponse, RefreshTokenDetailResponse

class RefreshTokenMapper:
    @staticmethod
    def to_response_dto(model: Any) -> RefreshTokenResponse:
