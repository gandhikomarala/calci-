"""Integration Test: Celery Distributed Batch Transaction Scoring, Progress Polling, and CSV Output Export."""
...
@pytest.mark.asyncio
async def test_test_batch_prediction_worker_task_execution():
