"""Full-Text Search Document Builder for InvestigationAssignment."""

from typing import Dict, Any, List
from backend.core.logging import get_logger

logger = get_logger("investigation_assignments_search")

class InvestigationAssignmentSearchIndex:
    INDEX_NAME = "finguard_investigation_assignments"
