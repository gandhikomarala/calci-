"""Domain DTO Serialization & Hydration Mapper for PredictionExplanation."""

from typing import Dict, Any, List, Optional
import datetime
from backend.prediction_explanations.schemas import PredictionExplanationResponse, PredictionExplanationDetailResponse

class PredictionExplanationMapper:
    @staticmethod
    def to_response_dto(model: Any) -> PredictionExplanationResponse:
