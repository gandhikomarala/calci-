// ModelRegistryPage: Model Registry, Version Tags, Staging-to-Production Promotion & Rollback
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-100">ModelRegistry</h2>
          <p className="text-sm text-slate-400">Model Registry, Version Tags, Staging-to-Production Promotion & Rollback</p>
        </div>
