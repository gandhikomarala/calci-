"""SQLAlchemy 2.0 Mapped Entity Model for ModelArtifact (Serialized artifact references (Joblib, LightGBM binaries, SHAP))."""
...
class ModelArtifact(Base, TimestampMixin, SoftDeleteMixin):
    ...
    __table_args__ = (
        Index("ix_model_artifacts_created_active", "created_at", "is_active"),
    )

    def __repr__(self) -> str:
        return f"<ModelArtifact(id='{self.id}', code='{self.code}', is_active={self.is_active})>"
