"""SQLAlchemy 2.0 Mapped Entity Model for CustomerProfile (360 behavioral profiles, baseline spending, and home regions)."""
...
class CustomerProfile(Base, TimestampMixin, SoftDeleteMixin):
    ...
    __table_args__ = (
        Index("ix_customer_profiles_created_active", "created_at", "is_active"),
    )

    def __repr__(self) -> str:
        return f"<CustomerProfile(id='{self.id}', code='{self.code}', is_active={self.is_active})>"
