"""Domain DTO Serialization & Hydration Mapper for InvestigationComment."""

from typing import Dict, Any, List, Optional
import datetime
from backend.investigation_comments.schemas import InvestigationCommentResponse, InvestigationCommentDetailResponse

class InvestigationCommentMapper:
    @staticmethod
    def to_response_dto(model: Any) -> InvestigationCommentResponse:
