"""Domain DTO Serialization & Hydration Mapper for MerchantCategory."""

from typing import Dict, Any, List, Optional
import datetime
from backend.merchant_categories.schemas import MerchantCategoryResponse, MerchantCategoryDetailResponse

class MerchantCategoryMapper:
    @staticmethod
    def to_response_dto(model: Any) -> MerchantCategoryResponse:
        return MerchantCategoryResponse(
