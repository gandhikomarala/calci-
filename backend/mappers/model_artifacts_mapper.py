"""Domain DTO Serialization & Hydration Mapper for ModelArtifact."""

from typing import Dict, Any, List, Optional
import datetime
from backend.model_artifacts.schemas import ModelArtifactResponse, ModelArtifactDetailResponse

class ModelArtifactMapper:
    @staticmethod
    def to_response_dto(model: Any) -> ModelArtifactResponse:
