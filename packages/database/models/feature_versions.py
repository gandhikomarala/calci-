"""SQLAlchemy 2.0 Mapped Entity Model for FeatureVersion (Versioned schemas of transformed feature spaces)."""
...
class FeatureVersion(Base, TimestampMixin, SoftDeleteMixin):
    ...
    __table_args__ = (
        Index("ix_feature_versions_created_active", "created_at", "is_active"),
    )

    def __repr__(self) -> str:
        return f"<FeatureVersion(id='{self.id}', code='{self.code}', is_active={self.is_active})>"
