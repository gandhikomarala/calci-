"""Full-Text Search Document Builder for ExperimentRun."""

from typing import Dict, Any, List
from backend.core.logging import get_logger

logger = get_logger("experiment_runs_search")

class ExperimentRunSearchIndex:
    INDEX_NAME = "finguard_experiment_runs"
