"""Domain DTO Serialization & Hydration Mapper for UserSession."""

from typing import Dict, Any, List, Optional
import datetime
from backend.sessions.schemas import UserSessionResponse, UserSessionDetailResponse

class UserSessionMapper:
    @staticmethod
    def to_response_dto(model: Any) -> UserSessionResponse:
