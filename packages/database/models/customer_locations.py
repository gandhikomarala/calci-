"""SQLAlchemy 2.0 Mapped Entity Model for CustomerLocation (Customer residential, billing, and work locations)."""
...
class CustomerLocation(Base, TimestampMixin, SoftDeleteMixin):
    ...
    __table_args__ = (
        Index("ix_customer_locations_created_active", "created_at", "is_active"),
    )

    def __repr__(self) -> str:
        return f"<CustomerLocation(id='{self.id}', code='{self.code}', is_active={self.is_active})>"
