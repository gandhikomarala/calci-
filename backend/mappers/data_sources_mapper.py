"""Domain DTO Serialization & Hydration Mapper for DataSource."""

from typing import Dict, Any, List, Optional
import datetime
from backend.data_sources.schemas import DataSourceResponse, DataSourceDetailResponse

class DataSourceMapper:
    @staticmethod
    def to_response_dto(model: Any) -> DataSourceResponse:
