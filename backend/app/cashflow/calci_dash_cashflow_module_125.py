"""
Calci Studio — Scientific RPN & Loan Amortization Suite — Discounted Cash Flow (DCF) & IRR Calculator (Unit 125)
...
@dataclass
class CashflowAnalyzerState_125:
    state_id: str
    is_valid: bool
...
class CashflowAnalyzer_125:
    ...
    def __init__(self, node_tag: str = "node_calci_dash_125"):
        ...
        self.active_state_cache: Dict[str, CashflowAnalyzerState_125] = {}

    def execute_processing_cycle(self, input_data: List[float], user_context: str = "production_client") -> CashflowAnalyzerState_125:
        self.invocations += 1
        ...
        state = CashflowAnalyzerState_125(
