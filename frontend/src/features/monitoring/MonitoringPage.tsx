// MonitoringPage: Inference Latency (p50/p95/p99), Throughput (TPS) & API Error Rate Dashboard
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-400">Inference Latency (p50/p95/p99), Throughput (TPS) & API Error Rate Dashboard</p>
        </div>
