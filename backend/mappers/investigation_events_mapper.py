"""Domain DTO Serialization & Hydration Mapper for InvestigationEvent."""

from typing import Dict, Any, List, Optional
import datetime
from backend.investigation_events.schemas import InvestigationEventResponse, InvestigationEventDetailResponse

class InvestigationEventMapper:
    @staticmethod
    def to_response_dto(model: Any) -> InvestigationEventResponse:
        return InvestigationEventResponse(
