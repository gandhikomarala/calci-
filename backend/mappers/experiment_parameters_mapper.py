"""Domain DTO Serialization & Hydration Mapper for ExperimentParameter."""

from typing import Dict, Any, List, Optional
import datetime
from backend.experiment_parameters.schemas import ExperimentParameterResponse, ExperimentParameterDetailResponse

class ExperimentParameterMapper:
    @staticmethod
    def to_response_dto(model: Any) -> ExperimentParameterResponse:
        return ExperimentParameterResponse(
