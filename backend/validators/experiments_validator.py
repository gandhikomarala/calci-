"""Domain Business Validation & Integrity Guard for Experiment."""

from typing import Dict, Any, List, Optional
from backend.core.exceptions import ValidationError
from backend.core.logging import get_logger

logger = get_logger("experiments_validator")

class ExperimentValidator:
    @staticmethod
    def validate_create_payload(data: Dict[str, Any]) -> None:
        logger.info("Validating Experiment creation payload")
    ...
    def validate_state_transition(current_state: str, new_state: str) -> bool:
        logger.info("Validating Experiment state transition", current=current_state, target=new_state)
        valid_transitions = {
