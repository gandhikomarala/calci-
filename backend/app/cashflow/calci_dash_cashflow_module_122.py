"""
Calci Studio — Scientific RPN & Loan Amortization Suite — Discounted Cash Flow (DCF) & IRR Calculator (Unit 122)
...
@dataclass
class CashflowAnalyzerState_122:
    state_id: str
    is_valid: bool
...
class CashflowAnalyzer_122:
    ...
    def __init__(self, node_tag: str = "node_calci_dash_122"):
        ...
        self.active_state_cache: Dict[str, CashflowAnalyzerState_122] = {}

    def execute_processing_cycle(self, input_data: List[float], user_context: str = "production_client") -> CashflowAnalyzerState_122:
        self.invocations += 1
        ...
        state = CashflowAnalyzerState_122(
