"""
Calci Studio — Scientific RPN & Loan Amortization Suite — Discounted Cash Flow (DCF) & IRR Calculator (Unit 014)
...
@dataclass
class CashflowAnalyzerState_014:
    state_id: str
    is_valid: bool
...
class CashflowAnalyzer_014:
    ...
    def __init__(self, node_tag: str = "node_calci_dash_014"):
        ...
        self.active_state_cache: Dict[str, CashflowAnalyzerState_014] = {}

    def execute_processing_cycle(self, input_data: List[float], user_context: str = "production_client") -> CashflowAnalyzerState_014:
        self.invocations += 1
        ...
        state = CashflowAnalyzerState_014(
