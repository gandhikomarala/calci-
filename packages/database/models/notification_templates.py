"""SQLAlchemy 2.0 Mapped Entity Model for NotificationTemplate (Configurable alert notification message templates)."""
...
class NotificationTemplate(Base, TimestampMixin, SoftDeleteMixin):
    ...
    __table_args__ = (
        Index("ix_notification_templates_created_active", "created_at", "is_active"),
    )

    def __repr__(self) -> str:
        return f"<NotificationTemplate(id='{self.id}', code='{self.code}', is_active={self.is_active})>"
