"""Full-Text Search Document Builder for ModelDeployment."""

from typing import Dict, Any, List
from backend.core.logging import get_logger

logger = get_logger("model_deployments_search")

class ModelDeploymentSearchIndex:
    INDEX_NAME = "finguard_model_deployments"
