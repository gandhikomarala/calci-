"""
Calci Studio — Scientific RPN & Loan Amortization Suite — Reverse Polish Notation Stack Evaluator & BigNum Engine (Unit 120)
...
class RPNEngine_120:
    ...
    def __init__(self, node_tag: str = "node_calci_dash_120"):
        ...
        self.active_state_cache: Dict[str, RPNEngineState_120] = {}

    def execute_processing_cycle(self, input_data: List[float], user_context: str = "production_client") -> RPNEngineState_120:
        self.invocations += 1
