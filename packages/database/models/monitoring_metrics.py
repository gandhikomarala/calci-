"""SQLAlchemy 2.0 Mapped Entity Model for MonitoringMetric (Inference latency, throughput, and error rate telemetry)."""
...
class MonitoringMetric(Base, TimestampMixin, SoftDeleteMixin):
    ...
    __table_args__ = (
        Index("ix_monitoring_metrics_created_active", "created_at", "is_active"),
    )

    def __repr__(self) -> str:
        return f"<MonitoringMetric(id='{self.id}', code='{self.code}', is_active={self.is_active})>"
