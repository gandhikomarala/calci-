"""SQLAlchemy 2.0 Mapped Entity Model for ExperimentMetric (Step-wise and final evaluation metrics (PR-AUC, ROC-AUC, F1))."""
...
class ExperimentMetric(Base, TimestampMixin, SoftDeleteMixin):
    ...
    __table_args__ = (
        Index("ix_experiment_metrics_created_active", "created_at", "is_active"),
    )

    def __repr__(self) -> str:
        return f"<ExperimentMetric(id='{self.id}', code='{self.code}', is_active={self.is_active})>"
