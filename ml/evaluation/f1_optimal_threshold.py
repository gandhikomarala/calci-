"""Macro, Micro and Binary Weighted F1 Score Threshold Optimizer."""
...
logger = get_logger("f1_optimal_threshold")

class F1OptimalThreshold:
    @staticmethod
    def evaluate(y_true: np.ndarray, y_proba: np.ndarray) -> Dict[str, Any]:
        logger.info("Computing f1_optimal_threshold metrics", samples=len(y_true))
