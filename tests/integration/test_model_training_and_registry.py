"""Integration Test: End-to-End LightGBM Training, Metric Evaluation, Registry Stage Promotion, and Rollback."""
...
@pytest.mark.asyncio
async def test_test_model_training_and_registry_execution():
