"""SQLAlchemy 2.0 Mapped Entity Model for DriftReport (Statistical feature and prediction drift audit reports)."""
...
class DriftReport(Base, TimestampMixin, SoftDeleteMixin):
    ...
    __table_args__ = (
        Index("ix_drift_reports_created_active", "created_at", "is_active"),
    )

    def __repr__(self) -> str:
        return f"<DriftReport(id='{self.id}', code='{self.code}', is_active={self.is_active})>"
