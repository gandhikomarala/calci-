"""Full-Text Search Document Builder for ExperimentParameter."""

from typing import Dict, Any, List
from backend.core.logging import get_logger

logger = get_logger("experiment_parameters_search")

class ExperimentParameterSearchIndex:
    INDEX_NAME = "finguard_experiment_parameters"
