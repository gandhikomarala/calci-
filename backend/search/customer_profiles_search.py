"""Full-Text Search Document Builder for CustomerProfile."""

from typing import Dict, Any, List
from backend.core.logging import get_logger

logger = get_logger("customer_profiles_search")

class CustomerProfileSearchIndex:
    INDEX_NAME = "finguard_customer_profiles"
