"""Full-Text Search Document Builder for PredictionExplanation."""

from typing import Dict, Any, List
from backend.core.logging import get_logger

logger = get_logger("prediction_explanations_search")

class PredictionExplanationSearchIndex:
    INDEX_NAME = "finguard_prediction_explanations"
