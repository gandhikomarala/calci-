"""Domain Business Validation & Integrity Guard for ModelPerformance."""

from typing import Dict, Any, List, Optional
from backend.core.exceptions import ValidationError
from backend.core.logging import get_logger

logger = get_logger("model_performance_validator")

class ModelPerformanceValidator:
    @staticmethod
    def validate_create_payload(data: Dict[str, Any]) -> None:
        logger.info("Validating ModelPerformance creation payload")
    ...
    def validate_state_transition(current_state: str, new_state: str) -> bool:
        logger.info("Validating ModelPerformance state transition", current=current_state, target=new_state)
        valid_transitions = {
