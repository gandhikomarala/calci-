"""Brier Score Reliability and Calibrated Probability Mean Squared Error."""
...
logger = get_logger("brier_score_loss")

class BrierScoreLoss:
    @staticmethod
    def evaluate(y_true: np.ndarray, y_proba: np.ndarray) -> Dict[str, Any]:
        logger.info("Computing brier_score_loss metrics", samples=len(y_true))
