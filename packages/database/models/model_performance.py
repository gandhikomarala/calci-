"""SQLAlchemy 2.0 Mapped Entity Model for ModelPerformance (Ground-truth evaluated production model performance over time)."""
...
class ModelPerformance(Base, TimestampMixin, SoftDeleteMixin):
    ...
    __table_args__ = (
        Index("ix_model_performance_created_active", "created_at", "is_active"),
    )

    def __repr__(self) -> str:
        return f"<ModelPerformance(id='{self.id}', code='{self.code}', is_active={self.is_active})>"
