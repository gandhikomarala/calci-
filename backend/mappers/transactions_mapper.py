"""Domain DTO Serialization & Hydration Mapper for Transaction."""

from typing import Dict, Any, List, Optional
import datetime
from backend.transactions.schemas import TransactionResponse, TransactionDetailResponse

class TransactionMapper:
    @staticmethod
    def to_response_dto(model: Any) -> TransactionResponse:
