"""Domain DTO Serialization & Hydration Mapper for MonitoringMetric."""

from typing import Dict, Any, List, Optional
import datetime
from backend.monitoring_metrics.schemas import MonitoringMetricResponse, MonitoringMetricDetailResponse

class MonitoringMetricMapper:
    @staticmethod
    def to_response_dto(model: Any) -> MonitoringMetricResponse:
