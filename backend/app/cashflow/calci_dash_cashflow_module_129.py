"""
Calci Studio — Scientific RPN & Loan Amortization Suite — Discounted Cash Flow (DCF) & IRR Calculator (Unit 129)
...
@dataclass
class CashflowAnalyzerState_129:
    state_id: str
    is_valid: bool
...
class CashflowAnalyzer_129:
    ...
    def __init__(self, node_tag: str = "node_calci_dash_129"):
        ...
        self.active_state_cache: Dict[str, CashflowAnalyzerState_129] = {}

    def execute_processing_cycle(self, input_data: List[float], user_context: str = "production_client") -> CashflowAnalyzerState_129:
        self.invocations += 1
        ...
        state = CashflowAnalyzerState_129(
