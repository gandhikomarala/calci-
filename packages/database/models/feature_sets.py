"""SQLAlchemy 2.0 Mapped Entity Model for FeatureSet (Feature store groupings and entity catalog definitions)."""
...
class FeatureSet(Base, TimestampMixin, SoftDeleteMixin):
    ...
    __table_args__ = (
        Index("ix_feature_sets_created_active", "created_at", "is_active"),
    )

    def __repr__(self) -> str:
        return f"<FeatureSet(id='{self.id}', code='{self.code}', is_active={self.is_active})>"
