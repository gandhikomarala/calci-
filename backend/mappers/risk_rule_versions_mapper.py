"""Domain DTO Serialization & Hydration Mapper for RiskRuleVersion."""

from typing import Dict, Any, List, Optional
import datetime
from backend.risk_rule_versions.schemas import RiskRuleVersionResponse, RiskRuleVersionDetailResponse

class RiskRuleVersionMapper:
    @staticmethod
    def to_response_dto(model: Any) -> RiskRuleVersionResponse:
        return RiskRuleVersionResponse(
