"""Unit test for Velocity24hTransformer."""

import pytest
import pandas as pd
import numpy as np
from ml.features.velocity_24h import Velocity24hTransformer

def test_velocity_24h_fit_transform():
    df = pd.DataFrame({
    ...
    transformer = Velocity24hTransformer()
