"""Domain DTO Serialization & Hydration Mapper for ExperimentMetric."""

from typing import Dict, Any, List, Optional
import datetime
from backend.experiment_metrics.schemas import ExperimentMetricResponse, ExperimentMetricDetailResponse

class ExperimentMetricMapper:
    @staticmethod
    def to_response_dto(model: Any) -> ExperimentMetricResponse:
