"""Domain DTO Serialization & Hydration Mapper for FeatureSet."""

from typing import Dict, Any, List, Optional
import datetime
from backend.feature_sets.schemas import FeatureSetResponse, FeatureSetDetailResponse

class FeatureSetMapper:
    @staticmethod
    def to_response_dto(model: Any) -> FeatureSetResponse:
