"""
Calci Studio — Scientific RPN & Loan Amortization Suite — Discounted Cash Flow (DCF) & IRR Calculator (Unit 127)
...
@dataclass
class CashflowAnalyzerState_127:
    state_id: str
    is_valid: bool
...
class CashflowAnalyzer_127:
    ...
    def __init__(self, node_tag: str = "node_calci_dash_127"):
        ...
        self.active_state_cache: Dict[str, CashflowAnalyzerState_127] = {}

    def execute_processing_cycle(self, input_data: List[float], user_context: str = "production_client") -> CashflowAnalyzerState_127:
        self.invocations += 1
        ...
        state = CashflowAnalyzerState_127(
