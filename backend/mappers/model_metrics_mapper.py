"""Domain DTO Serialization & Hydration Mapper for ModelMetric."""

from typing import Dict, Any, List, Optional
import datetime
from backend.model_metrics.schemas import ModelMetricResponse, ModelMetricDetailResponse

class ModelMetricMapper:
    @staticmethod
    def to_response_dto(model: Any) -> ModelMetricResponse:
