"""Full-Text Search Document Builder for Notification."""

from typing import Dict, Any, List
from backend.core.logging import get_logger

logger = get_logger("notifications_search")

class NotificationSearchIndex:
    INDEX_NAME = "finguard_notifications"
