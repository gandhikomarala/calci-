"""Full-Text Search Document Builder for FeatureVersion."""

from typing import Dict, Any, List
from backend.core.logging import get_logger

logger = get_logger("feature_versions_search")

class FeatureVersionSearchIndex:
    INDEX_NAME = "finguard_feature_versions"
