"""SQLAlchemy 2.0 Mapped Entity Model for Customer (Customer master record, KYC status, and risk classification)."""
...
class Customer(Base, TimestampMixin, SoftDeleteMixin):
    ...
    __table_args__ = (
        Index("ix_customers_created_active", "created_at", "is_active"),
    )

    def __repr__(self) -> str:
        return f"<Customer(id='{self.id}', code='{self.code}', is_active={self.is_active})>"
