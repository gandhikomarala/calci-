"""Domain DTO Serialization & Hydration Mapper for PredictionBatch."""

from typing import Dict, Any, List, Optional
import datetime
from backend.prediction_batches.schemas import PredictionBatchResponse, PredictionBatchDetailResponse

class PredictionBatchMapper:
    @staticmethod
    def to_response_dto(model: Any) -> PredictionBatchResponse:
