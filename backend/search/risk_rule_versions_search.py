"""Full-Text Search Document Builder for RiskRuleVersion."""

from typing import Dict, Any, List
from backend.core.logging import get_logger

logger = get_logger("risk_rule_versions_search")

class RiskRuleVersionSearchIndex:
    INDEX_NAME = "finguard_risk_rule_versions"
