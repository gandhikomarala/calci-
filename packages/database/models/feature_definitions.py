"""SQLAlchemy 2.0 Mapped Entity Model for FeatureDefinition (Mathematical specifications of engineered fraud features)."""
...
class FeatureDefinition(Base, TimestampMixin, SoftDeleteMixin):
    ...
    __table_args__ = (
        Index("ix_feature_definitions_created_active", "created_at", "is_active"),
    )

    def __repr__(self) -> str:
        return f"<FeatureDefinition(id='{self.id}', code='{self.code}', is_active={self.is_active})>"
