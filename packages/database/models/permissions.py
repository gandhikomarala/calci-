"""SQLAlchemy 2.0 Mapped Entity Model for Permission (Granular system permission registry)."""
...
class Permission(Base, TimestampMixin, SoftDeleteMixin):
    ...
    __table_args__ = (
        Index("ix_permissions_created_active", "created_at", "is_active"),
    )

    def __repr__(self) -> str:
        return f"<Permission(id='{self.id}', code='{self.code}', is_active={self.is_active})>"
