"""Full-Text Search Document Builder for InvestigationEvidence."""

from typing import Dict, Any, List
from backend.core.logging import get_logger

logger = get_logger("investigation_evidence_search")

class InvestigationEvidenceSearchIndex:
    INDEX_NAME = "finguard_investigation_evidence"
