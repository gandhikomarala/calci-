// AlertsPage: Fraud Alert Triage Center, SLA Urgency Badges & Automated Analyst Assignment
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-400">Fraud Alert Triage Center, SLA Urgency Badges & Automated Analyst Assignment</p>
        </div>
