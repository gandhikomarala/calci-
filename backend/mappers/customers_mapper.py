"""Domain DTO Serialization & Hydration Mapper for Customer."""

from typing import Dict, Any, List, Optional
import datetime
from backend.customers.schemas import CustomerResponse, CustomerDetailResponse

class CustomerMapper:
    @staticmethod
    def to_response_dto(model: Any) -> CustomerResponse:
