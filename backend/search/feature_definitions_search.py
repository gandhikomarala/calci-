"""Full-Text Search Document Builder for FeatureDefinition."""

from typing import Dict, Any, List
from backend.core.logging import get_logger

logger = get_logger("feature_definitions_search")

class FeatureDefinitionSearchIndex:
    INDEX_NAME = "finguard_feature_definitions"
