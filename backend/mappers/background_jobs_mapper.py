"""Domain DTO Serialization & Hydration Mapper for BackgroundJob."""

from typing import Dict, Any, List, Optional
import datetime
from backend.background_jobs.schemas import BackgroundJobResponse, BackgroundJobDetailResponse

class BackgroundJobMapper:
    @staticmethod
    def to_response_dto(model: Any) -> BackgroundJobResponse:
