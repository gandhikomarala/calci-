"""SQLAlchemy 2.0 Mapped Entity Model for CustomerDevice (Mapping of customers to trusted and suspicious device entities)."""
...
class CustomerDevice(Base, TimestampMixin, SoftDeleteMixin):
    ...
    __table_args__ = (
        Index("ix_customer_devices_created_active", "created_at", "is_active"),
    )

    def __repr__(self) -> str:
        return f"<CustomerDevice(id='{self.id}', code='{self.code}', is_active={self.is_active})>"
