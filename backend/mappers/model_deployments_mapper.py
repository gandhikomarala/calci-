"""Domain DTO Serialization & Hydration Mapper for ModelDeployment."""

from typing import Dict, Any, List, Optional
import datetime
from backend.model_deployments.schemas import ModelDeploymentResponse, ModelDeploymentDetailResponse

class ModelDeploymentMapper:
    @staticmethod
    def to_response_dto(model: Any) -> ModelDeploymentResponse:
