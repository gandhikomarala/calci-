"""Domain DTO Serialization & Hydration Mapper for DataQualityReport."""

from typing import Dict, Any, List, Optional
import datetime
from backend.data_quality_reports.schemas import DataQualityReportResponse, DataQualityReportDetailResponse

class DataQualityReportMapper:
    @staticmethod
    def to_response_dto(model: Any) -> DataQualityReportResponse:
