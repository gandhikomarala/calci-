"""SQLAlchemy 2.0 Mapped Entity Model for DataSource (External data source connectors, database links, and S3 buckets)."""
...
class DataSource(Base, TimestampMixin, SoftDeleteMixin):
    ...
    __table_args__ = (
        Index("ix_data_sources_created_active", "created_at", "is_active"),
    )

    def __repr__(self) -> str:
        return f"<DataSource(id='{self.id}', code='{self.code}', is_active={self.is_active})>"
