"""Unit test for MCCDiversityTransformer."""

import pytest
import pandas as pd
import numpy as np
from ml.features.mcc_diversity_index import MCCDiversityTransformer

def test_mcc_diversity_index_fit_transform():
    df = pd.DataFrame({
    ...
    transformer = MCCDiversityTransformer()
