"""Domain DTO Serialization & Hydration Mapper for User."""

from typing import Dict, Any, List, Optional
import datetime
from backend.users.schemas import UserResponse, UserDetailResponse

class UserMapper:
    @staticmethod
    def to_response_dto(model: Any) -> UserResponse:
        return UserResponse(
